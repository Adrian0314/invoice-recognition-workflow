...
echo.
echo   -- 完整版（需先 pip install -r requirements.txt）--
...
if "%choice%"=="2" "%PYEXE%" optimized_python\idle_invoice_bot.py -i invoices_input -o output
if "%choice%"=="3" "%PYEXE%" optimized_python\idle_invoice_bot.py -i invoices_input -o output --dry-run
if "%choice%"=="4" "%PYEXE%" optimized_python\idle_invoice_bot.py -i invoices_input -o output --force
